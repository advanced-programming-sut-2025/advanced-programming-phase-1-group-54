...
import static controller.Game.DataBaseController.loadJsonArray;
...
public class WorldBuilder {
    ...
    public static World getResult() {
        ...
        ArrayList<NPC> NPSs = buildNPCs();
        World world = new World(playerFarms, shops, NPSs, new Map(World.getNumberOfRows(), World.getNumberOfColumns(), tiles));
        WorldBuilder.reset();
        return world;
    }

    private static ArrayList<NPC> buildNPCs() {
