...
public class CommonGameController {
    ...
    static Result passOut(String username) {
        GameApp.getCurrentGame().getPlayerByUsername(username).setEnergy(0);
        return new Result(true, "you passed out!\n" + nextTurn(username).message());
    }

    public static Result nextTurn(String username) {
        Game game = GameApp.getCurrentGame();
        game.nextTurn();
    ...
    public static Result showEnergy(String username) {
        Game game = GameApp.getCurrentGame();
        Player player = game.getPlayerByUsername(username);
    ...
    public static Result showCurrentTool(String username) {
        Game game = GameApp.getCurrentGame();
        Player player = game.getPlayerByUsername(username);
    ...
    public static Result showAvailableTools(String username) {
        Game game = GameApp.getCurrentGame();
        Player player = game.getPlayerByUsername(username);
...
//        }
    ...
    static int numberOfItemInBackPack(String ItemName,String username) {
    ...
    static void removeItemFromBackPack(String ItemName, int number,String username) {
        Player player = GameApp.getCurrentGame().getPlayerByUsername(username);
        ...
        if (ItemName.equals("fish")) {
            ...
            if (number > amount) {
                removeItemFromInventory(produce, amount,username);
                number -= amount;
                removeItemFromInventory(Produce.getProduce("Large " + ItemName), number,username);
            } else {
                removeItemFromInventory(produce, number,username);
            }
        } else if (ItemName.equals("Oil")) {
            ...
            if (number > amount) {
                ...
                if (number > amount) {
                    removeItemFromInventory(produce, amount,username);
                    number -= amount;
                    removeItemFromInventory(Produce.getProduce("Sunflower " + ItemName), number,username);
                } else {
                    removeItemFromInventory(produce, number,username);
                }
            } else {
    ...
    static boolean removeItemFromInventory(Item item, int number,String username) {
    ...
    static boolean deleteThingOnTile(Tile tile, Farm farm,String username) {
        Player player = GameApp.getCurrentGame().getPlayerByUsername(username);
        ...
        if (tile.getThingOnTile() instanceof FeatureArtisan featureArtisan) {
            ...
            return deleteThingOnTile(tile.getTop(), farm,username);
    ...
    public static Result sell(String product, int count,String username) {
        Game game = GameApp.getCurrentGame();
