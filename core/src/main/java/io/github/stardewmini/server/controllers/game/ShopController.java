...
public class ShopController {
    ...
    public static Result buy(String itemName, String name, int price,String locationString,String username) {
        int x;
        int y;
        ...
        if(Animal.getAnimal(itemName) != null){
            ...
            result = CheatController.addAnimal(animal,name,location,username);
        }
        else {
            result = CheatController.addBuilding(itemName,location,username);
        }
