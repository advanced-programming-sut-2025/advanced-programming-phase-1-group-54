...
public class ToolsController {
    ...
    public static Result throwInTrash(String itemName, String numberString) {
        ...
        Item item = io.github.stardewmini.client.controllers.game.CommonGameController.findItem(itemName);
        if (item == null) {
    ...
    public static Result useTool(Direction direction) {
        ...
        if (!enoughEnergy) {
            Result passOut = io.github.stardewmini.client.controllers.game.CommonGameController.passOut();
            message += "\n" + passOut.message();
        }
