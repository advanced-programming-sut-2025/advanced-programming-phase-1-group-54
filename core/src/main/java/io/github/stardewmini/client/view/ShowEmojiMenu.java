...
public class ShowEmojiMenu implements Screen {

    private Stage stage;
    private final Window window;
    private final TextButton backButton;

    public ShowEmojiMenu(Skin skin) {
        this.window = new Window("Show Emoji Menu",skin);
    ...
    public void show() {
        ...
        EmojiController.showSelectedEmojis(window);
