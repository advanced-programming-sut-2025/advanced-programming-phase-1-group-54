package io.github.stardewmini.lwjgl3;

import com.badlogic.gdx.backends.lwjgl3.Lwjgl3Application;
import com.badlogic.gdx.backends.lwjgl3.Lwjgl3ApplicationConfiguration;
import io.github.stardewmini.Main;
import io.github.stardewmini.client.app.ClientApp;
import io.github.stardewmini.server.ServerMain;
import io.github.stardewmini.server.app.ListenerThread;
import io.github.stardewmini.server.app.LobbyCheckThread;
...
public class ServerLauncher {
    public static void main(String[] args) {
        ...
        try {
            ...
            ServerApp.setLobbyCheckThread(new LobbyCheckThread());
            ServerApp.startLobbyCheckThread();
    ...
    private static Lwjgl3Application createApplication() {
        return new Lwjgl3Application(new ServerMain(), getDefaultConfiguration());
    }
